            ...
            try {
                ...
                if (!result.success) {
                    ...
                    setNotification({
                        ...
                        type: "success",
                        title: "Berhasil",
                        message: "✅ Booking berhasil diajukan! Status: PENDING.\nSilakan cek Dashboard untuk melihat status.",
                    });
                    setDate("");
                    setStartTime("");
                    setEndTime("");
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div className="relative w-full max-w-md rounded-2xl border border-border bg-surface p-6 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* Date */}
                        <div>
                            <label htmlFor="bookingDate" className="mb-1.5 block text-sm font-medium text-foreground">
                                Tanggal
                            </label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-border bg-surface py-3 pl-10 pr-4 text-sm text-foreground outline-none transition-all focus:border-primary/50 focus:ring-4 focus:ring-primary/10"
                                />
                            </div>
                        </div>
